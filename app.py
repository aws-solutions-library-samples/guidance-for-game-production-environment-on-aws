...
virtual_desktop_stack = VirtualWorkstationStack(app, "gpic-pipeline-virtual-workstation", foundation_stack.bucket, foundation_stack.vpc, env={'region': os.environ['CDK_DEFAULT_REGION']})
